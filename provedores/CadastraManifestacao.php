    ...
    if(!empty($_POST)){       
       ...
       $manifestacoes->inserir_manifestacao($motivo_manifestacao, $id_entidade_manifestacao, $id_tipo_manifestacao, $conteudo_manifestacao, $observacoes_manifestacao, $local_manifestacao, $arquivo_manifestacao, $id_usuario_manifestacao, 'A', $data_manifestacao, $protocolo_manifestacao);
        ...
        try {
            ...
            //Recipients
            $mail->setFrom('naoresponda@l3tecnologia.app.br', 'Nova Solicitação na Ouvidoria');
            ...
            <body>
            <main><center><div class="container mt-5 text-center"> <div class="card shadow-lg p-4"><img src="https://l3tecnologia.app.br/ouvidoriaweb/assets/images/ouvidoria_web.png" width="300px" class="img-fluid mt-3 rounded"><h1 class="text-primary">Nova Solicitação Recebida!</h1><p class="mt-3 text-muted">Uma nova solicitação foi enviada à ouvidoria. Acesse a plataforma e confira a solicitação.</p><div class="mt-4"></div></div></div></center>
                </main>
