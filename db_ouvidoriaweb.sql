...
--
-- Host: 127.0.0.1
-- Tempo de geração: 18-Dez-2024 às 12:16
...
(20, 'Falta de transparencia', 1, 2, '//remove efeitos positivos\r\n          btnCodigo.classList.add(', 'Sem observações', 'Portal da transpar&ecirc;ncia', 'Sem anexos', 2, 'A', '2024-11-14', '1-2-141124151105');
...
INSERT INTO `tb_usuario` (`id_usuario`, `nome_usuario`, `sobrenome_usuario`, `cpf_usuario`, `email_usuario`, `senha_usuario`) VALUES
(2, 'Luan ', 'Leandro Nogueira', '11769868488', 'luannogueira093@gmail.com', '$2y$10$jzQSAyxizTuM/mrmo13xK.owpOmy4s9DAzCsWxVPcb6vA/0rHl/k6'),
...
--
ALTER TABLE `tb_manifestacoes`
  MODIFY `id_manifestacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
